...
public class MaintenanceEntryController {
	...
	@Autowired  //dependency injection - declaration style
	...
	@PostMapping("/addMaintenance") //@ResponseBody public String
	...
	@GetMapping("/DeleteDetail/{id}") //@ResponseBody public String
